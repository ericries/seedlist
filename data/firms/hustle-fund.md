...
team:
  ...
  - name: Haley Bryant
    ...
    slug: haley-bryant
  - name: Brian Nichols
    role: GM - Angel Squad / Venture Partner
    slug: brian-nichols
  - name: Wael Jabir
    role: Chief of Staff
    slug: wael-jabir
...
**Check size:** The firm's initial check evolved from $25,000 in Fund I to $150,000 in Fund III [^16][^20]. Elizabeth Yin has noted the firm writes approximately 80 checks per year, "around one to two companies per week" [^21].
