...
founded: 2005
fund_size: "$12B+ AUM; $700M Fund VIII early-stage (2024); $1.4B Growth V (2024); $700M Fund VII (2021); $1.4B Growth IV (2021)"
stage_focus: [pre-seed, seed, series-a, series-b, growth]
sector_focus: [ai, consumer, enterprise, fintech, infrastructure, developer-tools, deep-tech, crypto]
team:
  - slug: santo-politi
    role: "Founder & General Partner (Early Stage)"
    name: "Santo Politi"
  - slug: nabeel-hyatt
    role: "General Partner (Early Stage)"
    name: "Nabeel Hyatt"
  - slug: alex-finkelstein
    role: "General Partner (Early Stage)"
  ...
  - slug: arpan-shah
    role: "General Partner (Early Stage)"
    name: "Arpan Shah"
  - slug: mikowai-ashwill
    role: "Investor (Early Stage)"
  ...
  - slug: coen-armstrong
    role: "Investor (Growth)"
    name: "Coen Armstrong"
  - slug: james-kuklinski
    role: "Investor (Growth)"
    name: "James Kuklinski"
  - slug: bijan-sabet
    role: "Co-Founder & General Partner Emeritus"
    name: "Bijan Sabet"
  - slug: paul-conway-spark
    role: "Co-Founder & General Partner Emeritus"
    name: "Paul Conway"
  - slug: todd-dagres
    role: "Co-Founder & General Partner Emeritus"
...
Spark Capital is a multi-stage venture capital firm founded in 2005 by Bijan Sabet, Paul Conway, Santo Politi, and Todd Dagres [^1][^2]. The firm was born in Boston, initially operating from a small space in Cambridge, Massachusetts, before relocating to an office above a shoe store on Newbury Street in Boston [^2]. Spark has since expanded with offices in San Francisco, New York, and Boston [^1][^2].

The firm manages over $12 billion in assets [^1][^3]. Spark has raised eight early-stage funds: $265 million (2005), $360 million (2008), $360 million (2010), $450 million (2013), $400 million (2016), $450 million (2019), $700 million (2021), and $700 million (2024) [^1]. It has also raised five growth funds: $375 million (2014), $600 million (2016), $900 million (2019), $1.4 billion (2021), and $1.4 billion (2024) [^1]. As of March 2026, the firm was reportedly raising $3 billion for its next set of funds [^3].

Spark's portfolio includes 45 unicorns, 15 IPOs, and 89 acquisitions across 337 companies [^4]. The firm's most celebrated early investments include Twitter (Series B lead in 2008, jointly with Union Square Ventures) and Slack, both led by co-founder Bijan Sabet [^1][^5].

In recent years, the firm promoted Fraser Kelton (previously Head of Product at OpenAI) and Clay Fisher to General Partner, and brought on Natalie Vais (formerly of Amplify Partners) as a new General Partner [^6].

## Stated Thesis

Spark Capital publicly describes its investment philosophy as product-first: "Product comes first, and everything else follows" [^7]. The firm states it invests in "products we love, people, crazy, dreams, design, details, brains, reality, unreality, reinvention, new markets, weird stuff, guts, independence, hustle, distinction, art, humanness, idealists, oddities, optimism, communities, creation, surprises, technologists with the heart of an artist" [^2][^8].

The firm uses the metaphor: "A ship is safest at the dock, but that's not the point of a ship" to reflect its belief in bold action over caution [^8].

Spark explicitly rejects standardized playbooks: "Culture and individual company circumstances drive success, not formulas" [^8]. The firm values "no standardized playbooks," "pattern-breaking," "long-term commitment," and "user-centric" investing [^8].

Co-founder Bijan Sabet has described Spark as aiming to build "a new kind of firm — one that would push back against the traditions, good and bad, of typical venture capital" [^2].

## Inferred Thesis

Based on Spark Capital's verified portfolio of 337 investments [^4] and publicly listed companies [^9]:

**Sector distribution:** Spark's portfolio page lists companies across AI/ML (Anthropic, Scale AI, Pika, MatX, Lightmatter, Baseten, Adept), consumer/social (Twitter, Tumblr, Snap, Discord, Niantic), fintech (Affirm, Plaid, Ramp, Mercury, Coinbase, Marqeta, Kalshi), enterprise (Slack, Trello, Benchling, Granola), developer tools/infrastructure (Crusoe, Enfabrica, Chainguard), deep tech/hardware (Oculus, Framework, Stoke Space, Inversion, Edison Scientific), and biotech (WildType, Profluent, Formation Bio) [^9]. The portfolio skews heavily toward consumer and product-driven companies historically, with a significant recent pivot toward AI and deep tech.

**Stage distribution:** Spark operates separate early-stage and growth fund teams [^1]. The firm's check sizes range from $500K to $60M, covering pre-seed through Series B, with growth investments handled by the dedicated growth team [^7]. Decision timeline is approximately 2 weeks [^7].

**Geographic distribution:** While headquartered in San Francisco with offices in New York and Boston, Spark's portfolio is predominantly US-based [^1][^2].

**Investment style:** General Partner Nabeel Hyatt has described backing only one or two companies per year, reflecting deep conviction investing [^10]. He has explained: "if you're a startup CEO or running a small org, you can manage eight or nine reports where you understand everything they're doing, and outside of that, the edges get fuzzy" [^10].

**Notable behavioral patterns:**
- Spark has a strong track record with consumer social products (Twitter, Tumblr, Snap, Discord, Foursquare — many co-invested with Union Square Ventures) [^1][^5].
- The firm has shifted significantly toward AI and deep tech in 2024-2025, with investments in Anthropic, Pika, MatX, Lightmatter, and Baseten [^9].
- The recent GP promotions (Fraser Kelton from OpenAI, Natalie Vais) signal deliberate team building around AI expertise [^6].
- Spark's branding emphasizes founder loyalty — its logo is a dog, symbolizing "loyalty and companionship with founders" [^8].
...
| Anthropic | Series C (lead) | 2023-05-23 | AI | [^9][^49] |
...
| CivilGrid | Series A (led, $26M; Energy Impact Partners, Afore Capital, A*, Ford Street Ventures, SNR Ventures participated) | 2026-08-27 | Infrastructure / Construction Tech / Utility Data | [^civg-sp1][^civg-sp2][^civg-sp3] |

This table represents a subset of Spark Capital's 337 total investments [^4].

## In Their Own Words

Spark Capital states: "Product comes first, and everything else follows" [^7].

The firm's manifesto describes investing in "products we love, people, crazy, dreams, design, details, brains, reality, unreality, reinvention, new markets, weird stuff, guts, independence, hustle, distinction, art, humanness, idealists, oddities, optimism, communities, creation, surprises, technologists with the heart of an artist" [^8].

Nabeel Hyatt on his selective approach: "if you're a startup CEO or running a small org, you can manage eight or nine reports where you understand everything they're doing, and outside of that, the edges get fuzzy" [^10].

Co-founder Bijan Sabet described starting Spark to build "a new kind of firm — one that would push back against the traditions, good and bad, of typical venture capital" [^2].

## What Founders Say

A founder who worked with Nabeel Hyatt described him as "a straight shooter with strong opinions" who is "wise without being arrogant" and "loyal, hard-working, and genuinely cares about the entrepreneurs with whom he works" [^11]. The founder highlighted that Nabeel's experience as an entrepreneur helps him empathize with founders [^11].

## Sources

[^1]: Wikipedia, "Spark Capital," accessed March 2026. https://en.wikipedia.org/wiki/Spark_Capital
[^2]: Crunchbase, "Bijan Sabet - Co-Founder and General Partner @ Spark Capital," accessed March 2026. https://www.crunchbase.com/person/bijan-sabet
[^3]: TechCrunch, "VC mega-funds are back with General Catalyst, Spark rumored to be raising billions," March 2026, accessed March 2026. https://techcrunch.com/2026/03/11/vc-mega-funds-are-back-with-general-catalyst-spark-rumored-to-be-raising-billions/
[^4]: Tracxn, "Spark Capital - 2025 Investor Profile," accessed March 2026. https://tracxn.com/d/venture-capital/spark-capital/__mODt1i5BYDWaPfk-iLnH5snYnPHjX0j0rSXCUPB3rb8
[^5]: The Boston Globe, "With $2 billion in new funds, Spark Capital doubles down on tech," March 2022, accessed March 2026. https://www.bostonglobe.com/2022/03/09/business/with-2-billion-new-funds-spark-capital-doubles-down-tech/
[^6]: Medium/Spark Capital, "We have three new general partners at Spark," accessed March 2026. https://medium.com/spark-capital/we-have-three-new-general-partners-at-spark-895459f478ce
[^7]: F4 Fund, "Spark Capital — Investment Thesis & Preferences," accessed March 2026. https://f4.fund/firms/spark-capital
[^8]: Spark Capital website, homepage, accessed March 2026. https://www.sparkcapital.com/
...
[^k2d-sp1]: PR Newswire, "K2 Space Raises $500M Series D at $6.8B Valuation to Scale Large, High-Power Satellites," July 30, 2026, accessed August 2026. https://www.prnewswire.com/news-releases/k2-space-raises-500m-series-d-at-6-8b-valuation-to-scale-large-high-power-satellites-302838793.html — Primary company press release confirming July 30, 2026 announcement of $500M Series D at $6.8B post-money valuation co-led by Kleiner Perkins and ICONIQ with participation from Spark Capital, CapitalG, Lightspeed, Altimeter, Sands Capital, ARK Invest, T. Rowe Price Associates, and other existing investors.
[^k2d-sp2]: Bloomberg, "Satellite Startup K2 Space Raises $500 Million at $6.8 Billion Value," July 30, 2026, accessed August 2026. https://www.bloomberg.com/news/articles/2026-07-30/iconiq-backs-satellite-startup-k2-space-at-6-8-billion-value — Tier-1 press confirmation of $500M Series D at $6.8B valuation co-led by Kleiner Perkins and ICONIQ with Spark Capital among named participants.
[^k2d-sp3]: Payload Space, "K2 Space Raises $500M Series D at $6.8B Valuation," July 30, 2026, accessed August 2026. https://payloadspace.com/k2-space-raises-500m-series-d-at-6-8b-valuation/ — Independent space-industry trade press confirmation of the round; names Spark Capital, CapitalG, Lightspeed, Altimeter, Sands Capital, ARK Invest, and T. Rowe Price Associates as participants.
...
[^civg-sp1]: BusinessWire, "CivilGrid Raises $26M Series A Financing To Drive U.S. Critical Infrastructure Modernization," August 27, 2026. Accessed September 2026. https://www.businesswire.com/news/home/20260827753660/en/CivilGrid-Raises-$26M-Series-A-Financing-To-Drive-U.S.-Critical-Infrastructure-Modernization — Primary company newswire confirming Spark Capital led CivilGrid's $26M Series A on August 27, 2026 with Energy Impact Partners, Afore Capital, A*, Ford Street Ventures, and SNR Ventures participating; Josh Mackanic founder/CEO; San Francisco-based.
[^civg-sp2]: Dealroom News, "CivilGrid raises $26M Series A to map what's buried underground," August 27, 2026. Accessed September 2026. https://dealroom.co/news/147400-civilgrid-raises-26m-series-a-to-map-whats-buried-underground/ — Independent tech-press confirmation of Spark Capital as lead, with Afore Capital, Ford Street Ventures, SNR, and Energy Impact Partners as participants.
[^civg-sp3]: FinSMEs, "CivilGrid Raises $26M in Series A Funding," August 28, 2026. Accessed September 2026. https://www.finsmes.com/2026/08/civilgrid-raises-26m-in-series-a-funding.html — Third independent trade press confirmation of $26M Series A, Spark Capital lead, with Energy Impact Partners, Afore Capital, A*, Ford Street Ventures, and SNR Ventures as participants; San Francisco headquarters; Josh Mackanic CEO.
