...
Menlo Ventures is one of Silicon Valley's oldest venture capital firms, founded in 1976 by H. DuBose Montgomery [^1][^2]. The firm is headquartered in Menlo Park, California, with an additional presence in San Francisco [^1].

Over nearly 50 years, Menlo Ventures has grown to manage more than $5.8 billion in assets [^2]. The firm's portfolio includes more than 85 public companies and over 170 exits through mergers and acquisitions, with 25 unicorns [^2][^3]. As of March 2026, Menlo Ventures has invested in 466 companies, with 31 new investments in the last 12 months [^3].

In November 2023, the firm raised $1.35 billion across two vehicles: Menlo XVI (early-stage) and Menlo Inflection III (early growth) [^4]. In July 2024, Menlo Ventures partnered with Anthropic to launch the Anthology Fund, a $100 million initiative to back AI-native startups at pre-seed through Series A stages [^5][^6]. By December 2024, the Anthology Fund had selected its first cohort of 18 companies from thousands of applications [^7].

## Stated Thesis

Menlo Ventures publicly describes itself as "ALL IN on AI," signaling that artificial intelligence is the firm's dominant current investment focus [^1]. The firm invests across multiple technology sectors including AI, bio and healthcare, consumer, cybersecurity, fintech, infrastructure, robotics and hardware, SaaS, and supply chain and automation [^1].

The firm's tagline is: "When we invest, we're invested" — emphasizing active involvement beyond passive capital provision [^1].

Through the Anthology Fund, Menlo has articulated five specific AI investment themes [^5]:
1. AI Infrastructure — developer tools and middleware advancing LLM adoption
2. Frontier AI Applications — transforming bio, healthcare, legal, financial services, and cybersecurity
3. Consumer AI Solutions — integrating LLMs into user experiences
4. Trust and Safety Tooling — responsible AI deployment
5. Societal Benefit AI — education, job creation, and accessibility

Six Menlo partners lead the Anthology Fund: Deedy Das, Amy Wu Martin, Venky Ganesan, Tim Tully, Matt Murphy, and Joff Redfern, working alongside Anthropic President Daniela Amodei and CPO Mike Krieger [^5].

## Inferred Thesis

Based on Menlo Ventures' verified portfolio data:

**Stage distribution:** The firm invests from seed through growth. Recent fundraising separates early-stage (Menlo XVI) from early growth (Inflection III), suggesting a dual-track approach [^4]. The Anthology Fund focuses specifically on pre-seed to Series A [^5].

**Sector focus:** Menlo's current portfolio reflects a heavy AI tilt. Key sectors include AI/ML (Anthropic, Pinecone, Abnormal AI), fintech (Chime, Betterment, Carta), cybersecurity (Abnormal Security, BitSight), enterprise SaaS (Harness, Benchling), consumer (Roku, Poshmark, Rover), and healthcare (Recursion, PillPack) [^1][^3].

**AI as defining bet:** Menlo's investment in Anthropic, combined with the $100M Anthology Fund partnership, represents one of the most concentrated AI bets by any venture firm. The firm produces an annual "State of Generative AI" report, positioning itself as a thought leader in the AI investment landscape [^8].

**Notable exits:** Key liquidity events include Uber, Roku (IPO), Chime (IPO on Nasdaq), Poshmark, Warby Parker, PillPack (acquired by Amazon), and Siri (acquired by Apple) [^1][^3].

**Co-investor patterns:** The Anthropic partnership gives Menlo a structural advantage in AI deal flow, as portfolio companies receive Anthropic model credits and access to Anthropic's research team [^5].

**Geographic focus:** Primarily U.S.-based, with the Anthology Fund considering exceptional international companies [^5].
...
| Rover | Early | ~2014 | Consumer Marketplace | IPO [^3] |
| Warby Parker | Growth | ~2015 | Consumer | IPO [^3] |
| Harness | Growth | ~2020 | Developer Tools | Private [^1] |
| Benchling | Growth | ~2019 | Life Sciences | Private [^1] |
| Recursion | Growth | ~2020 | Healthcare/AI | Public [^1] |
...
| Lovable | Series C (co-led with Scaleup Europe Fund/EQT, $400M at $13.3B val; Balderton Capital, Carmignac, Kaszek Ventures, LTS Growth, Tencent, World Innovation Lab, Regent also participating; returning: Accel, Antler, CapitalG, DST Global, Evantic Capital, HubSpot Ventures, Salesforce Ventures) | 2026-08-12 | AI / Developer Tools / Vibe Coding | Private [^lov-c-1][^lov-c-2] |
...
| Sapiom | Seed (participated, $15.75M; Accel led — Ilan Zerbib's AI-agent infrastructure company) | 2026-02-06 | AI / Agent Infrastructure / Developer Tools | Private [^sapiom-mv1][^sapiom-mv2][^sapiom-mv3] |
| Sapiom | Series A (participated, $35M; Dragonfly led with Haseeb Qureshi; Accel, Gradient, Coinbase Ventures, Operator Collective, Formus Capital, VanEck Ventures, Okta Ventures, Anthropic, Array Ventures also participating; $50M total funding) | 2026-08-05 | AI / Agent Infrastructure / Developer Tools | Private [^sapiom-mv1][^sapiom-mv2][^sapiom-mv3] |
| Wispr | Series B (led, $280M at $2B post-money val; Matt Kraning was investing partner; returning investors Notable Capital, NEA, Neo Ventures, 8VC, MVP Ventures; new investors Acrew, Forerunner, Goodwater, Peak XV, Together Fund, PLUS Capital; brings Wispr's total funding to $361M) | 2026-08-17 | AI / Voice AI / Speech Recognition / Productivity | Private [^wispr-mv1][^wispr-mv2][^wispr-mv3] |
...
No independently verified direct quotes found from Menlo Ventures partners beyond website marketing copy.
...
[^1]: Menlo Ventures website, homepage, accessed March 2026. https://menlovc.com/
[^2]: Menlo Ventures overview, Capital AUM, accessed March 2026. https://capitalaum.com/venture-capital/menloventures-menlopark-ca.htm
[^3]: Tracxn, "Menlo Ventures — 2026 Investor Profile," accessed March 2026. https://tracxn.com/d/venture-capital/menloventures/__Rm57TwDiGwWoGLH7WShryso4_li5L-0uSGfAnE7ghGI
[^4]: Bloomberg, "Menlo Ventures Raises $1.35 Billion in Funds for AI Investments," November 16, 2023. https://www.bloomberg.com/news/articles/2023-11-16/menlo-ventures-raises-1-35-billion-in-funds-for-ai-investments
[^5]: Menlo Ventures website, "Anthology Fund," accessed March 2026. https://menlovc.com/anthology-fund/
...
[^sapiom-mv1]: Sapiom, "Sapiom Raises $35M Series A to Power the Next Trillion AI Agents" (company Series A announcement), August 5, 2026. Accessed September 2026. https://www.sapiom.ai/blog/series-a — Primary company source. Names Menlo Ventures among Series A participants alongside Accel, Gradient, Coinbase Ventures, Operator Collective, Formus Capital, VanEck Ventures, Okta Ventures, Anthropic, and Array Ventures behind Dragonfly's lead. Confirms Menlo Ventures as a returning seed investor (Feb 2026 $15.75M Accel-led seed). Founder Ilan Zerbib quoted: "Every team is being forced to recreate the same infrastructure before its agents can perform real work. Sapiom exists to remove those barriers."

[^sapiom-mv2]: BusinessWire, "Sapiom Raises $35 Million Series A to Power the Next Trillion AI Agents," August 5, 2026. Accessed September 2026. https://www.businesswire.com/news/home/20260805915898/en/Sapiom-Raises-%2435-Million-Series-A-to-Power-the-Next-Trillion-AI-Agents — Primary company-issued press release naming Menlo Ventures as a returning seed investor participating in the $35M Series A led by Dragonfly. $50M total funding; 270M+ transactions processed; 100,000+ daily agents.

[^sapiom-mv3]: PYMNTS, "Sapiom Secures $35 Million to Help Companies Control AI Agent Costs," August 5, 2026. Accessed September 2026. https://www.pymnts.com/news/artificial-intelligence/2026/sapiom-secures-35-million-to-help-companies-control-ai-agent-costs/ — Third independent contemporaneous tech press confirmation of Menlo Ventures' continued participation in Sapiom Series A.

[^lov-c-1]: TechCrunch, "Lovable confirms new $13.3B valuation, raises another $400M," August 12, 2026. Accessed September 2026. https://techcrunch.com/2026/08/12/lovable-confirms-new-13-3b-valuation-raises-another-400m/ — Contemporaneous tier-1 press confirming Menlo Ventures co-led the $400M Series C alongside Scaleup Europe Fund at $13.3B valuation, with more than a dozen other investors participating.
[^lov-c-2]: Lovable blog, "Lovable Series C" announcement, August 12, 2026. Accessed September 2026. https://lovable.dev/blog/series-c — Startup's own announcement confirming $400M Series C at $13.3B valuation co-led by Menlo Ventures and Scaleup Europe Fund (managed by EQT); Menlo Partner Matt Murphy quoted; Balderton Capital, Carmignac, Kaszek Ventures, LTS Growth, Tencent, World Innovation Lab, and Regent listed among participants; returning investors include Accel, Antler, CapitalG, DST Global, Evantic Capital, HubSpot Ventures, and Salesforce Ventures.

[^wispr-mv1]: TechCrunch, "Wispr raises $280M at $2B valuation as it looks beyond dictation," August 17, 2026. Accessed September 24, 2026. https://techcrunch.com/2026/08/17/wispr-raises-280m-at-2b-valuation-as-it-looks-beyond-dictation/ — Tier-1 tech press primary confirmation that Menlo Ventures led Wispr's $280M Series B on August 17, 2026 at $2B valuation. Returning investors Notable Capital, NEA, Neo Ventures, 8VC, MVP Ventures; new investors Acrew, Forerunner, Goodwater, Peak XV, Together Fund, PLUS Capital.

[^wispr-mv2]: Wispr Flow blog, "Our Series B, and what it means for you," August 17, 2026. Accessed September 24, 2026. https://wisprflow.ai/post/series-b — Startup's own announcement confirming Menlo Ventures as lead of the $280M Series B at $2B valuation; total capital raised to date $361M.

[^wispr-mv3]: Allie Garfinkle, "Wispr talks its way to a $2 billion valuation. The company says dictation's only the beginning," Fortune, August 17, 2026. Accessed September 24, 2026. https://fortune.com/2026/08/17/wispr-2-billion-valuation-dictations-only-the-beginning/ — Third independent tier-1 press confirmation. Names Matt Kraning as the Menlo Ventures partner leading the deal, quoted: "Dictation is how you get in the door. What people pay for is not having to type, which puts you up against workflow tools, meeting tools, and eventually the text box in front of every AI model."
