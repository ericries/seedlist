...
Gigascale Capital is an early-stage venture capital firm focused on climate technology, founded in 2023 by Mike Schroepfer, the former Chief Technology Officer of Meta [^1][^2]. The firm announced its $250 million Fund I on June 1, 2026 — its first fund backed by outside institutional investors [^1][^3].

Gigascale's thesis centers on what it calls "rebuilding the physical economy" — backing companies addressing acute constraints in clean energy, grid infrastructure, automation, critical minerals, and supply chains, particularly to meet rising power demand from AI and electrification [^1][^3]. The firm positions itself as backing technologies that win on cost and performance first, with climate impact as a downstream consequence of adoption at scale [^1].
...
The firm explicitly targets areas where supply constraints are "most acute" — clean energy generation, grid infrastructure, critical materials, and the supply chains that connect them [^1][^3].

## Inferred Thesis

Based on the publicly disclosed portfolio (sample size: small — only a subset of 25+ portfolio companies disclosed):

- **Sector concentration:** Heavy concentration in energy generation (fusion, nuclear, baseload power) and grid/power electronics. Disclosed names include Commonwealth Fusion Systems and Xcimer (fusion), Radiant (small modular nuclear), Arbor Energy (clean baseload power), Heron Power (industrial power electronics), Form Energy (long-duration storage), Dioxycle (sustainable chemicals), and Mill (consumer waste/circular) [^1][^12].
...
| Xcimer Energy | Series A ($100M, participant; lead: Hedosophia; co-participants: Breakthrough Energy Ventures, Lowercarbon Capital, Prelude Ventures, Emerson Collective, Starlight Ventures) | 2024-06-04 | -- | Fusion energy | active [^6][^15] |
| Radiant Nuclear | Series C ($165M close, participant; lead: DCVC; new co-participants: StepStone, Giant Ventures, Hanwha Asset Management, SGA, Crossbeam Venture Partners, Align Ventures, ARK Venture Fund, HartBeat Ventures, Pax Ventures) | 2025-06-04 | -- | Small modular nuclear | active [^7][^16][^17] |
| Arbor Energy | Series A ($55M, participant; co-leads: Lowercarbon, Voyager) | 2025-10-21 | -- | Clean baseload power | active [^8] |
| Heron Power | Series B ($140M, participant as existing investor; co-leads: a16z American Dynamism, Breakthrough Energy Ventures; co-participants: Capricorn Investment Group, Energy Impact Partners, Valor Atreides AI Fund) | 2026-02-18 | -- | Industrial power electronics | active [^9][^18][^19] |
...
[^15]: Latitude Media, "With Xcimer raise, cleantech investors once again bet on nuclear fusion," June 5, 2024. Accessed August 2026. https://www.latitudemedia.com/news/with-xcimer-raise-cleantech-investors-once-again-bet-on-nuclear-fusion/ — Independently confirms Xcimer $100M Series A led by Hedosophia with Breakthrough Energy Ventures, Emerson Collective, Lowercarbon Capital, Prelude Ventures, Gigascale Capital, and Starlight Ventures participating.
[^16]: Orrick, "Radiant Closes $165 Million in Series C Funding," June 2025. Accessed August 2026. https://www.orrick.com/en/News/2025/06/Radiant-Closes-165-Million-in-Series-C-Funding — Deal counsel disclosure confirming Radiant's $165M Series C closed June 3, 2025, led by DCVC with Gigascale Capital among the new investors.
[^17]: Nuclear Engineering International, "Radiant closes Series C microreactor funding," June 2025. Accessed August 2026. https://www.neimagazine.com/news/radiant-closes-series-c-microreactor-funding/ — Independent trade press confirming $165M Series C led by DCVC on June 4, 2025; names Gigascale Capital among new investors alongside StepStone, Giant Ventures, Hanwha, SGA, Crossbeam, Align, ARK Venture Fund, HartBeat Ventures, and Pax Ventures.
[^18]: TechCrunch, "Heron Power raises $140M to ramp production of grid-altering tech," February 18, 2026. Accessed August 2026. https://techcrunch.com/2026/02/18/heron-power-raises-140m-to-ramp-production-of-grid-altering-tech/ — Contemporaneous tier-1 press confirming $140M Series B co-led by a16z American Dynamism and Breakthrough Energy Ventures, with Capricorn, Energy Impact Partners, Valor Atreides AI Fund, and Gigascale Capital participating as existing investors.
[^19]: SolarQuarter, "Heron Power Raises $140M Series B To Build 40-GW U.S. Manufacturing Facility For Its Solid-State Heron Link Transformer Technology," February 19, 2026. Accessed August 2026. https://solarquarter.com/2026/02/19/heron-power-raises-140m-series-b-to-build-40-gw-u-s-manufacturing-facility-for-its-solid-state-heron-link-transformer-technology/ — Independent trade press confirming $140M Series B, co-leads, and Gigascale Capital participation.
