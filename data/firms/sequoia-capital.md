...
Sequoia Capital is an American venture capital firm founded by Don Valentine in 1972 in Menlo Park, California [^1][^2]. Valentine, a former sales executive at Fairchild Semiconductor and National Semiconductor, formed Sequoia's first venture capital fund in 1974 with $3 million [^1][^3]. The firm's earliest investments included Atari (1975) and Apple ($150,000 in 1978), establishing its pattern of identifying transformative technology companies at their earliest stages [^1][^4].

Valentine led the firm until recruiting Michael Moritz and Doug Leone, who became co-stewards — a term Sequoia uses instead of "managing partner" to reflect its culture of inherited, not purchased, leadership [^5][^6]. Moritz and Leone ran the firm for decades before handing stewardship to Roelof Botha, the former PayPal CFO, in 2017 [^5]. In November 2025, Botha stepped aside and Alfred Lin and Pat Grady were named co-stewards, returning the firm to its historical co-leadership model [^5][^6].

In October 2021, Sequoia dramatically restructured its U.S. and European operations, abandoning the traditional 10-year closed-end fund model in favor of an evergreen structure [^7][^8]. The new structure centers on the Sequoia Capital Fund, an open-ended vehicle that holds public company stakes and recycles returns into sub-funds for seed, venture, and growth investments [^7]. As part of this restructuring, Sequoia registered as a Registered Investment Adviser (RIA) with the SEC [^7]. By February 2025, the evergreen fund had grown to approximately $19.6 billion [^9].

In June 2023, Sequoia announced it would split into three independent entities, a separation completed by March 2024: Sequoia Capital (U.S. and Europe), HongShan (China), and Peak XV Partners (India and Southeast Asia) [^10][^11]. The split was driven by rising U.S.–China geopolitical tensions and the increasing complexity of running a decentralized global investment operation [^10][^11].

As of January 2025, Sequoia Capital manages approximately $56 billion in assets [^1]. The firm has invested in 1,668 companies over 48 years, with 134 unicorns in its portfolio [^12]. Companies backed by Sequoia have generated over $3.3 trillion in combined market capitalization [^4]. In October 2025, the firm launched $950 million in new early-stage funds: a $750 million venture fund and a $200 million seed fund (its sixth dedicated seed fund) [^13][^14].

The firm's most notable failure in recent years was its $214 million investment in FTX, made in July 2021 when the crypto exchange was valued at $18 billion [^15][^16]. Sequoia wrote the entire position down to zero in November 2022 following FTX's collapse. The $150 million from Global Growth Fund III represented less than 3% of committed capital, and the $63.5 million from the SCGE Fund was under 1% of portfolio [^15][^16]. Sequoia stated: "We are in the business of taking risk. Some investments will surprise to the upside, and some will surprise to the downside" [^15].
...
- **AI/ML**: rapidly growing allocation, with investments in OpenAI, Anthropic, xAI, and numerous AI-native startups [^14][^20]
...
- **Seed**: average $9.15M [^12] (dedicated $200M seed fund) [^13]
- **Series A**: average $17.6M [^12] (dedicated $750M venture fund) [^13]
- **Series B**: average $68.2M [^12]
- **Growth / Late Stage**: $100M–$1B+ (via evergreen fund; e.g., multi-billion-dollar AI rounds in OpenAI, Anthropic) [^9][^20]
...
Sequoia has historically favored technical founders building in large markets. Notable patterns include:
- Deep domain experts (Jensen Huang/Nvidia, Eric Yuan/Zoom, Patrick Collison/Stripe)
- Repeat founders and operators with prior scaling experience
- Immigrant founders (a longstanding pattern dating to Valentine's Apple and Nvidia bets)
- Founders with obsessive product focus (Brian Chesky/Airbnb, Jan Koum/WhatsApp)
...
- **Growth stage dominates by dollars despite seed/venture branding.** The $19.6 billion evergreen fund dwarfs the $950 million in early-stage funds [^9][^13]. By capital deployed, Sequoia is primarily a growth/crossover investor. By deal count, it is primarily seed/Series A.
...
- **Post-split geographic focus.** Since separating from HongShan and Peak XV in 2024, Sequoia's investable universe is now U.S. and Europe only [^10][^11]. This is a meaningful narrowing from the firm's prior global scope.
...
| Apple | Seed | 1978 | Hardware / Consumer | Public (IPO 1980) [^1][^4] |
| Oracle | Early | 1986 | Enterprise / Database | Public (IPO 1986) [^1][^4] |
| Cisco | Seed | 1987 | Networking / Infrastructure | Public (IPO 1990) [^1][^4] |
| NVIDIA | Seed | 1993 | Semiconductors / AI | Public (IPO 1999) [^23] |
| Yahoo | Early | 1995 | Consumer / Internet | Public (IPO 1996); Acquired by Apollo (2021) [^1][^4] |
...
| Bunkerhill Health | Seed (led, $6.5M; Alfred Lin) → Series B (participated, $25M; Khosla Ventures led; Felicis, Optum Ventures, Y Combinator joined) | 2023; 2026-07-16 | Healthcare / AI / Digital Health | Private [^bhh1][^bhh2][^bhh3][^bhh4] |
| Valar Atomics | Series B (led, $1B equity + $200M credit at ~$6B post-money; Shaun Maguire lead partner; Apandion Capital, Atreides Management, Conviction, Dream Ventures, HOF Capital, Point72, Riot Ventures, Snowpoint Ventures, Valor Equity Partners participated; Erebor and other banks provided credit line) | 2026-08-03 | Nuclear Energy / AI Infrastructure / Deep Tech | Private [^valar1][^valar2] |
| Form Energy | Series G (participated, new investor; $750M led by T. Rowe Price at $2B+ total equity raised) | 2026-08-12 | Climate / Long-Duration Energy Storage / Iron-Air Batteries | Private [^formg1][^formg2][^formg3] |
| AIR (air.security) | Seed 1 (led, $10M) → Seed 2 (participated; Greenoaks led $40M) | 2026-09-01 (both rounds disclosed together at stealth exit) | Cybersecurity / AI Agent Security / MCP / Enterprise | Private (~six-month-old Israel-based startup; founders Yair Saban (CEO) and Niv Hoffman (CTO), both Unit 8200 alumni; Bogomil Balkansky lead partner; angels include Zach Frankel (Cognition), Yinon Costica (Wiz), Ofir Ehrlich (Eon), Anne Neuberger, Omer Adam, Varun Anand (Clay); Swish and Netz also participated; total $50M raised) [^air1][^air2][^air3][^air4] |
| Empirik | Seed (led, $21M; incubated inside Sequoia since 2023; Bogomil Balkansky lead partner) | 2026-09-01 | AI Infrastructure / Change Observability / DevOps | Private (Sequoia spin-out; CEO Kartik Chandrayana (ex-Quantum Metric CPO, ex-Salesforce VP Observability); co-founders Avon Puri (Sequoia CDIO, ex-Rubrik/VMware) and Sudheer Dhurjati (Sequoia IT); Canapi and Alumni Ventures participated) [^empirik1][^empirik2][^empirik3] |
| Safe Superintelligence | Prior investor (predates 2026-07-27 Nvidia $5B strategic round) | 2024 | AI / Foundation Models / AI Safety | Private ($32B valuation as of Feb 2025) [^ssi-seq1][^ssi-seq2] |
| Profound | Series D (co-led with Kleiner Perkins, $180M at $1.8B post-money; Anas Biad and Alfred Lin authored the Sequoia partnership post) | 2026-09-15 | AI / Marketing / Answer Engine Optimization (AEO) | Private (Lightspeed Venture Partners, Khosla Ventures, Saga Ventures, Evantic, and South Park Commons participated; 1,000+ enterprise customers including Comcast, Estée Lauder, and Walmart) [^profound-seq1][^profound-seq2][^profound-seq3] |

*Note: This table includes 48 companies out of 1,668 total investments (~3%). Investment years marked with "~" are approximate based on company founding dates and publicly reported rounds. Many investments span multiple rounds; the stage listed reflects Sequoia's initial or most prominent investment.*
...
[^63]: Sequoia Capital, "Partnering with Auctor," April 15, 2026. Accessed May 2026. https://sequoiacap.com/article/partnering-with-auctor/ — Sequoia's own announcement of leading Auctor's $20M Series A on April 15, 2026 with participation from Y Combinator, M12 (Microsoft's Venture Fund), Workday Ventures, HubSpot Ventures, OneStream, Tercera, and Dig Ventures. Cross-referenced with GlobeNewsWire, "Auctor Raises $20M Led by Sequoia Capital to Build the AI System of Action for the Enterprise Software Implementation Market," April 15, 2026. https://www.globenewswire.com/news-release/2026/04/15/3274475/0/en/Auctor-Raises-20M-Led-by-Sequoia-Capital-to-Build-the-AI-System-of-Action-for-the-Enterprise-Software-Implementation-Market.html
...
[^79]: PR Newswire, "Mach Industries Raises $300 Million in Series C Funding," June 2, 2026. Accessed June 2026. https://www.prnewswire.com/news-releases/mach-industries-raises-300-million-in-series-c-funding-302787788.html — $300M Series C at $1.8B valuation announced June 2, 2026, co-led by Infinite Capital and Ribbit Capital. Press release explicitly states: "The new investors join longstanding backers including Bedrock Capital, Sequoia Capital, and Khosla Ventures, an investor group that has supported Mach Industries across multiple stages of its growth."

[^80]: Tech Funding News, "MIT dropout's Mach Industries bags $300M at $1.8B valuation as defence manufacturing enters a new era," June 2026. Accessed June 2026. https://techfundingnews.com/mit-dropouts-mach-industries-bags-300m-at-1-8b-valuation-as-defence-manufacturing-enters-a-new-era/ — Independent confirmation that Sequoia Capital is among the existing backers participating in the Series C alongside Bedrock Capital and Khosla Ventures.

[^81]: Pulse 2.0, "Mach Industries Raises $300 Million Series C At $1.8 Billion Valuation As Defense Tech Growth Accelerates," June 2026. Accessed June 2026. https://pulse2.com/mach-industries-raises-300-million-series-c-at-1-8-billion-valuation/ — Third independent confirmation that Sequoia Capital participated in the Series C as an existing investor alongside Bedrock Capital and Khosla Ventures.

[^82]: Sequoia Capital, "Partnering with Sandstone: An AI-Native Platform for In-House Legal Teams," by Bogomil Balkansky, January 13, 2026. Accessed June 2026. https://sequoiacap.com/article/partnering-with-sandstone-an-ai-native-platform-for-in-house-legal-teams/ — Sequoia's own announcement confirming it led Sandstone's Seed round; partner Bogomil Balkansky authored the post. Sequoia previously led the pre-seed round.
...
[^edx1]: CoinDesk, "Schwab, Citadel Securities, Fidelity, Other Wall Street Firms Start Crypto Exchange EDX Markets," September 13, 2022. Accessed July 2026. https://www.coindesk.com/business/2022/09/13/charles-schwab-citadel-fidelity-and-others-start-crypto-exchange-edx-markets — Founding announcement lists Sequoia Capital among EDX Markets' launch backers alongside Citadel Securities, Fidelity Digital Assets, Charles Schwab, Virtu Financial, and Paradigm.
[^edx2]: EDX Markets, "EDX Markets Launches Clearinghouse for Crypto Trading and Announces Completion of Series B Funding Round," January 24, 2024. Accessed July 2026. https://edxmarkets.com/edx-markets-launches-clearinghouse-for-crypto-trading-and-announces-completion-of-series-b-funding-round/ — Confirms Sequoia Capital (existing founding investor) co-led the January 2024 Series B with Pantera Capital (new investor).
...
[^etched2]: "Etched raises $300M at a $10.3B Valuation to Scale Production of Frontier Scale Inference Hardware," GlobeNewswire, July 23, 2026. Accessed July 24, 2026. https://www.globenewswire.com/news-release/2026/07/23/3332366/0/en/Etched-raises-300M-at-a-10-3B-Valuation-to-Scale-Production-of-Frontier-Scale-Inference-Hardware.html — Primary press release naming Sequoia as lead; Andreessen Horowitz, Jane Street, Diffusion, and SK Hynix as participants. Includes Sonya Huang (Sequoia Partner) quote.

[^bhh1]: Allie Garfinkle, "Bunkerhill Health raises $55 million to put AI agents to work inside hospitals," Fortune, July 16, 2026. Accessed July 29, 2026. https://fortune.com/2026/07/16/bunkerhill-health-raises-55-million-ai-agents-work-inside-hospitals/ — Tier-1 press confirming Khosla Ventures led Bunkerhill Health's $25M Series B on July 16, 2026, with Sequoia Capital, Felicis, Optum Ventures, and Y Combinator participating; brings total funding to $55M.
[^bhh2]: Bunkerhill Health, "Bunkerhill Health Raises $55 Million to Help Health Systems Turn Their Best Ideas into Reality," Series B announcement, July 16, 2026. Accessed July 29, 2026. https://www.bunkerhillhealth.com/resources/series-b-announcement — Company's own primary announcement naming Sequoia Capital as a Series B participant alongside Khosla Ventures (lead), Felicis, Optum Ventures, and Y Combinator.
[^bhh3]: HIT Consultant, "Bunkerhill Health Secures $55M to Expand Carebricks Agentic AI Platform for Health Systems," July 16, 2026. Accessed July 29, 2026. https://hitconsultant.net/2026/07/16/bunkerhill-health-closes-series-b-agentic-ai-carebricks/ — Trade-press cross-confirmation of the $25M Series B / $55M total raise, Khosla Ventures as lead, and Sequoia Capital, Felicis, Optum Ventures, and Y Combinator as participants.
[^bhh4]: Sequoia Capital, "Bunkerhill Health" portfolio page, sequoiacap.com. Accessed July 29, 2026. https://sequoiacap.com/companies/bunkerhill-health/ — Sequoia's own portfolio page confirms Bunkerhill Health as a Sequoia-backed company; Fortune coverage of the Series B ([^bhh1]) confirms Alfred Lin led the 2023 seed round for Sequoia.

[^valar1]: TechCrunch, "Sequoia's Shaun Maguire leads $1B round for nuclear startup Valar Atomics," August 3, 2026. Accessed August 2026. https://techcrunch.com/2026/08/03/sequoias-shaun-maguire-leads-1b-round-for-nuclear-startup-valar-atomics/ — Primary contemporaneous press confirming Sequoia's Shaun Maguire led the $1B equity Series B for Valar Atomics at ~$6B post-money, alongside a separate $200M credit line from Erebor and other banks; Apandion Capital, Atreides Management, Conviction, Dream Ventures, HOF Capital, Point72, Riot Ventures, Snowpoint Ventures, and Valor Equity Partners participated.
[^valar2]: AlleyWatch, "The AlleyWatch Startup Daily Funding Report: 8/3/2026," August 3, 2026. Accessed August 2026. https://alleywatch.com/2026/08/the-alleywatch-startup-daily-funding-report-8-3-2026/ — Independent cross-confirmation of Valar Atomics' $1B Series B on August 3, 2026 led by Sequoia's Shaun Maguire; participants listed match TechCrunch primary.

[^formg1]: Form Energy press release, "Form Energy Secures $750M in Series G Financing to Scale Iron-Air Battery Manufacturing and Accelerate Commercial Deployments," August 12, 2026. Accessed August 2026. https://formenergy.com/form-energy-secures-750m-in-series-g-financing/ — Primary company source confirming T. Rowe Price led the $750M Series G on August 12, 2026, with Sequoia Capital named among new investors alongside Janus Henderson, Franklin Templeton, and PEAK6 Investments; existing investors Prelude Ventures, Engine Ventures, TPG Rise Climate, Capricorn, Breakthrough Energy Ventures, Coatue, Energy Impact Partners, NGP, and GE Vernova also participated. Total equity raised >$2B.

[^formg2]: TechCrunch, "Form Energy raises $750M to build more 100-hour batteries for the grid," August 12, 2026. Accessed August 2026. https://techcrunch.com/2026/08/12/form-energy-raises-750m-to-build-more-100-hour-batteries-for-the-grid/ — Tier-1 tech press confirmation matching the press release verbatim on date, amount, T. Rowe Price as lead, and Sequoia Capital's participation as a new investor in the Series G.

[^formg3]: The Boston Globe, "Somerville's Form Energy lands $750m investment, in part to expand its West Virginia battery factory," August 12, 2026. Accessed August 2026. https://www.bostonglobe.com/2026/08/business/form-energy-vc-funding-750-million/ — Independent regional press cross-confirmation of Form Energy's $750M Series G with Sequoia Capital as a new investor.

[^air1]: TechCrunch, "AIR raises $50M to help companies vet the skills and add-ons AI agents use," September 1, 2026. Accessed September 2026. https://techcrunch.com/2026/09/01/air-raises-50m-to-help-companies-vet-the-skills-and-add-ons-ai-agents-use/ — Primary tier-1 tech press confirming Sequoia Capital led the $10M first seed round with Greenoaks leading the $40M second seed, both disclosed at September 1, 2026 stealth exit. Total $50M raised. Named angels: Zach Frankel (Cognition), Yinon Costica (Wiz), Ofir Ehrlich (Eon), Anne Neuberger, Omer Adam, Varun Anand (Clay). Founders Yair Saban (CEO) and Niv Hoffman (CTO). Includes Bogomil Balkansky quote.

[^air2]: AIR company blog, "AIR is Coming Out of Stealth" (Yair Saban byline), September 1, 2026. Accessed September 2026. https://www.air.security/blog-posts/out-of-stealth — Primary company announcement listing investors: Sequoia, Greenoaks, Swish, Netz, TTP, and unnamed angels. Names Ryan Knisley (former CISO Costco and Walt Disney) as Chief Strategy Officer.

[^air3]: Yahoo Finance, "AIR Emerges from Stealth With $50M to Build a Firewall for Agents," September 1, 2026. Accessed September 2026. https://finance.yahoo.com/technology/ai/articles/air-emerges-stealth-50m-build-150000907.html — Independent tier-1 financial press confirmation: Sequoia + Greenoaks as leads; Swish and Netz also participated; Bogomil Balkansky Sequoia Partner quote confirming Sequoia's lead posture and thesis.

[^air4]: CTech (Calcalist), "Six-month-old AIR Security raises $50 million to build a firewall for AI agents," September 1, 2026. Accessed September 2026. https://www.calcalistech.com/ctechnews/article/r13apdnugg — Independent Israeli tech press confirmation: Sequoia and Greenoaks as leads; founders' Unit 8200 background; ~40 employees in Israel; angel list including Zach Frankel, Yinon Costica, Ofir Ehrlich, Anne Neuberger, Omer Adam, Varun Anand.

[^empirik1]: TechCrunch, Marina Temkin, "Sequoia-incubated Empirik launches with $21M to predict outages before they happen," September 1, 2026. Accessed September 2026. https://techcrunch.com/2026/09/01/sequoia-incubated-empirik-launches-with-21m-to-predict-outages-before-they-happen/ — Primary tier-1 press confirming Sequoia Capital led Empirik's $21M seed round with Canapi and Alumni Ventures participating; company was incubated inside Sequoia beginning 2023 and spun out September 1, 2026. Bogomil Balkansky (Sequoia partner) quoted; CEO Kartik Chandrayana (formerly CPO Quantum Metric, VP Observability Salesforce) quoted. Co-founders Avon Puri (Sequoia CDIO since 2020, previously Rubrik and VMware) and Sudheer Dhurjati (Sequoia IT leader).
[^empirik2]: Tech Startups, "Venture Capital & Startup Funding Roundup, September 1, 2026: Andreessen Horowitz; General Catalyst, Sequoia Capital & More," September 1, 2026. Accessed September 2026. https://techstartups.com/2026/09/01/venture-capital-general-catalyst-sequoia-capital-more/ — Independent daily VC roundup cross-confirming Empirik's $21M seed on September 1, 2026 with Sequoia, Canapi, and Alumni Ventures; confirms Sequoia-incubated project began in 2023 and Chandrayana's prior roles at Quantum Metric and Salesforce.
[^empirik3]: Techmeme aggregation, "Empirik, which uses AI to predict and prevent IT outages by analyzing system changes and their effects, raised a $21M seed and spins out from Sequoia Capital (Marina Temkin/TechCrunch)," September 1, 2026, 2:16 PM. Accessed September 2026. https://www.techmeme.com/260901/p31 — Independent aggregator confirming the story broke on September 1, 2026 attributed to Marina Temkin/TechCrunch; validates date and circulation of the announcement.

[^ssi-seq1]: TechCrunch, "Ilya Sutskever's Safe Superintelligence partners with Nvidia to scale its AI research," July 27, 2026. Accessed September 2026. https://techcrunch.com/2026/07/27/ilya-sutskevers-safe-superintelligence-partners-with-nvidia-to-scale-its-ai-research/ — Article confirms: "Aside from Nvidia, the firm's backers included Andreessen Horowitz, Alphabet, Lightspeed Venture Partners, GV, Sequoia Capital Partners, and others." Establishes Sequoia Capital as a prior investor in Safe Superintelligence ahead of Nvidia's $5B strategic investment announced July 27, 2026.

[^ssi-seq2]: TechCrunch, "Ilya Sutskever's startup, Safe Super Intelligence, raises $1B," September 4, 2024. Accessed September 2026. https://techcrunch.com/2024/09/04/ilya-sutskevers-startup-safe-super-intelligence-raises-1b/ — Primary contemporaneous confirmation that Sequoia Capital participated in SSI's $1B round announced September 4, 2024 at a $5B valuation, alongside Andreessen Horowitz, DST Global, and SV Angel.

[^profound-seq1]: Dominic-Madori Davis, "AEO startup Profound hits unicorn valuation, raises $180M Series D 7 months after last round," TechCrunch, September 15, 2026. Accessed September 15, 2026. https://techcrunch.com/2026/09/15/aeo-startup-profound-hits-unicorn-valuation-raises-180m-series-d-7-months-after-last-round/ — Primary tier-1 tech press confirming Sequoia Capital and Kleiner Perkins co-led Profound's $180M Series D at a $1.8B valuation on September 15, 2026, with Lightspeed Venture Partners, Khosla Ventures, and South Park Commons participating; ~3x revenue growth over the preceding six months and 1,000+ enterprise customers (Comcast, Estée Lauder, Walmart).

[^profound-seq2]: Anas Biad, Brian Halligan, and Alfred Lin, "Partnering with Profound: Winning on the AI Stage," Sequoia Capital, September 15, 2026. Accessed September 15, 2026. https://www.sequoiacap.com/article/partnering-with-profound-winning-on-the-ai-stage — Primary lead-investor announcement authored by Sequoia partners Anas Biad, Brian Halligan, and Alfred Lin explaining the firm's decision to co-lead Profound's Series D alongside Kleiner Perkins.

[^profound-seq3]: James Cadwallader, "Building the AI platform for marketing" (Profound Series D announcement), Profound company blog, September 16, 2026. Accessed September 15, 2026. https://tryprofound.com/blog/series-d — Primary company source authored by Profound's Co-Founder & CEO confirming $180M Series D at $1.8B valuation and adding Saga Ventures and Evantic to the co-investor set beyond the TechCrunch list.
