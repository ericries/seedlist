...
team:
  ...
  - name: Nicolas Berman
    role: Partner
    slug: nicolas-berman
  - name: Mariana Donangelo
    role: Partner
    slug: mariana-donangelo
  - name: Santiago Fossatti
    role: Partner
    slug: santiago-fossatti
  - name: Angel Uribe
    role: Partner
    slug: angel-uribe
  - name: Andy Young
...
**Co-investor patterns:** Kaszek frequently co-invests with QED Investors (particularly in fintech), Tiger Global Management, Monashees, General Atlantic, Sequoia Capital, SoftBank, and Quona Capital [^7][^13]. Sequoia Capital has been an LP in Kaszek's funds since Fund I via Sequoia Heritage [^13].
...
| Konfio | Early | ~2016 | Fintech | Active [^6][^10] |
...
| Dr. Consulta | Early | ~2015 | Healthtech | Active [^5][^10] |
