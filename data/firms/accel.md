...
Accel is a global venture capital firm founded in 1983 by Arthur Patterson and Jim Swartz [^1][^2]. Patterson previously served as General Partner at Adler & Company after beginning his career at Citicorp Venture Capital; Swartz was the founding general partner of Adler & Company, which he started with Fred Adler in 1978 [^2].

The firm is headquartered in Palo Alto, California, with additional offices in San Francisco, London, Bangalore, and New York [^3]. Accel describes itself as a "first partner to exceptional teams everywhere" [^4].

Accel has invested in over 1,190 companies, generating 104 unicorns, 47 IPOs, and 382 acquisitions [^5]. The firm has raised approximately $19.56 billion across all funds [^5]. Its most celebrated investment was a $12.7 million investment in Facebook in May 2005 for 10% of the company — before the company had revenue — which was worth $6.6 billion at the time of Facebook's IPO in 2012 [^1][^6].

Recent fund activity includes a $4 billion growth fund closed in 2022 (the firm's largest single fundraise), a $650 million fund for Europe and Israel focused on AI and cybersecurity (May 2024), and a $650 million fund for India and Southeast Asia (January 2025) [^7][^8]. As of December 2025, Accel was targeting $4 billion for its latest growth fund [^8]. The firm's current fund size is reported at $9.6 billion [^9].

In Q2 2025, Accel and General Catalyst were ranked as the busiest active investors in venture capital [^9].

## Stated Thesis

Accel's founders developed a "prepared mind" investment philosophy, based on the Louis Pasteur quote "chance favors the prepared mind" [^2][^10]. This approach requires the team to develop deep expertise in specific categories and industries before investing, being proactive rather than reactive [^10].

The firm publicly positions itself as a "first partner to exceptional teams everywhere" and invests from seed through growth stages [^4]. Accel's focus areas span AI, enterprise software, consumer technology, fintech, cybersecurity, and infrastructure [^5][^9].

Accel has published research on AI trends through its annual "Globalscape" report, which in 2025 documented the "race for compute" amid surging valuations in AI [^11].

## Inferred Thesis

Based on Accel's verified portfolio of 1,190+ investments [^5], the following patterns emerge:

**Sector distribution:** Accel's recent investment activity is heavily weighted toward AI. In 2025, the firm led five rounds of $100 million or more in Q2 alone, including a $500 million financing for Perplexity and a $260 million Series C for True Anomaly [^9]. Major AI portfolio companies include Anysphere (Cursor), Perplexity, Lovable, n8n, Synthesia, and Cyera [^9]. Beyond AI, Accel maintains significant positions in enterprise SaaS (CrowdStrike, Qualtrics), consumer (Spotify, Etsy), and fintech (Venmo/Braintree).

**Stage distribution:** Accel operates separate early-stage and late-stage (growth) investment teams across all offices [^3]. The firm invests from seed through growth, with the $4 billion growth fund representing its largest vehicle [^8].

**Geographic distribution:** Accel has a genuinely global investment model with dedicated teams in the Bay Area, London, and Bangalore [^3]. The 2024 Europe/Israel fund and 2025 India/SEA fund demonstrate continued geographic expansion [^7][^8].

**Scale of returns:** Accel's investment in Scale AI yielded an expected $2.5 billion windfall following Meta's $14.3 billion investment at a $29 billion valuation [^12]. The Lovable Series A (AI-powered software builder in Stockholm) was among the largest Series A rounds ever raised in Europe [^9].

**Co-investor patterns:** Accel frequently co-invests with top-tier firms including Index Ventures, Sequoia, and Andreessen Horowitz.
...
| Perplexity | Series E ($500M, led at $14B valuation) | 2025-05-14 | AI | [^9][^55][^140] |
...
| FirstClub | Series A (co-led with RTP Global; $23M at $120M val) | 2025-09-03 | E-commerce / Quick Commerce / India | [^120][^121][^122] |
...
| Fixxly | Seed ($5.5M, led; Fireside Ventures and Lightspeed India Partners participated) | 2026-07-29 | Quick Commerce / Construction / Building Materials / AI / India | [^fixxly1][^fixxly2][^fixxly3] |
...
| Ema | Series B ($77M, participated — increased stake; Creaegis led; Section 32 and Prosus also participated with increased stakes; more than 4x valuation from 2024 round; $140M total raised) | 2026-09-23 | Enterprise AI / AI Agents / SaaS | [^ema1][^ema2][^ema3] |
| Cambridge Aerospace | Series C ($300M, participated; DFJ Growth led at $3.4B valuation; Lux Capital, Lakestar, Never Lift, Ora Global, and Elad Gil also participated) | 2026-08-10 | Defense Tech / Counter-Drone / Aerospace | [^cambaero1][^cambaero2][^cambaero3] |

This table represents a subset of Accel's 1,190+ total investments [^5].

## In Their Own Words

Accel's founders developed the firm's "prepared mind" investment philosophy based on the Louis Pasteur quote "chance favors the prepared mind," which they describe as requiring "deep focus" and a disciplined approach to investing [^2][^10].

Accel has stated that Prepared Minds involve "the team honing in on specific categories and industries, being proactive, talking to their network, researching trends shaping tomorrow's world, finding the category leader, and then moving fast" [^10].

## What Founders Say

A founder described Accel partners as "some of the best minds in the ecosystem, and just great people to have along in your journey" [^13].

Accel partner Dinesh Katiyar was described by a founder as "a great listener" who "will always allow the entrepreneur to complete his pitch and give his feedback or ask questions after" and is "probably the investor who is liked by all the founders in his portfolio" [^13].

Partner Barath Shankar Subramanian was noted by a founder as someone "who backs the founder once he has committed even in the toughest times" [^13].

One founder concluded: "if you are lucky to get Accel as an investor, go for it" [^13].

## Sources

[^1]: Wikipedia, "Accel (company)," accessed March 2026. https://en.wikipedia.org/wiki/Accel_(company)
[^2]: The Twenty Minute VC, "Accel Founders Arthur Patterson and Jim Swartz," accessed March 2026. https://www.thetwentyminutevc.com/jim-swartz-arthur-patterson
[^3]: Accel, "Contact Us," accessed March 2026. https://www.accel.com/contact-us
[^4]: Accel website, homepage, accessed March 2026. https://www.accel.com/
[^5]: Tracxn, "Accel - 2026 Investor Profile, Portfolio, Team & Investment Trends," accessed March 2026. https://tracxn.com/d/venture-capital/accel/__DOx04ZeK_m5ARGAaVgjbEzz_Ub3J4QM_vNkOmkQOi90
[^6]: Employbl, "Accel Portfolio Companies," accessed March 2026. https://www.employbl.com/company-collections/accel
[^7]: Private Equity International, "VC pioneer Accel seeks at least $4bn for latest growth fund," accessed March 2026. https://www.privateequityinternational.com/vc-pioneer-accel-seeks-at-least-4bn-for-latest-growth-fund/
[^8]: Venture Capital Journal, "Accel aims for $4bn with latest growth fund," accessed March 2026. https://www.venturecapitaljournal.com/accel-aims-for-4bn-with-latest-growth-fund/
[^9]: Crunchbase News, "Accel, General Catalyst Topped Increasingly Busy Active Investor Ranks In Q2," accessed March 2026. https://news.crunchbase.com/venture/busiest-investors-q2-2025-accel-general-catalyst/
[^10]: Accel, "Investing Outside Silicon Valley, Prepared Minds and How to Build Strong Boards," accessed March 2026. https://www.accel.com/noteworthies/investing-outside-silicon-valley-prepared-minds-and-how-to-build-strong-boards
...
[^55]: FinTech Weekly, "AI Startup Perplexity's Valuation Jumps to $14 Billion Following $500 Million Funding Round," May 14, 2025. Accessed May 2026. https://www.fintechweekly.com/magazine/articles/perplexity-ai-startup-valuation-14-billion-funding-round — Confirms Accel led Perplexity's $500M round in May 2025 at $14B valuation. Cross-referenced with CNBC, "Perplexity AI wrapping talks to raise $500 million at $14 billion valuation," May 12, 2025. https://www.cnbc.com/2025/05/12/perplexity-funding-round-comet.html — pre-announcement reporting that Accel was close to leading the round. NOTE: Fact-spec sweep 2026-07-27 corrected round designation from "Series D" to "Series E" — the December 2024 SoftBank/Nvidia/IVP-led $500M @ $9B was the actual Series D; the May 2025 Accel-led round is Series E per Tracxn round history [^140] and YourStory contemporaneous coverage of Perplexity's December 2024 Series D at $9B valuation.
...
[^108]: BusinessWire, "Tomo is the AI Champion Helping People Bet on Themselves, Emerging from Stealth with $5 Million," June 25, 2026. Accessed June 2026. https://www.businesswire.com/news/home/20260625645270/en/Tomo-is-the-AI-Champion-Helping-People-Bet-on-Themselves-Emerging-from-Stealth-with-$5-Million — Primary press release listing Accel as a participating investor in Tomo's $5M Seed led by Bain Capital Ventures (with Align Fund, Basis Set, Conviction, Pear VC also participating).

[^109]: Pulse 2.0, "Tomo Raises $5 Million Seed Round Led By Bain Capital Ventures," June 2026. Accessed June 2026. https://pulse2.com/tomo-raises-5-million-seed-round-led-by-bain-capital-ventures/ — Independent confirmation of Accel's participation in Tomo's seed round.
...
[^120]: Manish Singh, "FirstClub bucks India's speed obsession, quickly triples valuation to $120M with premium approach," TechCrunch, September 3, 2025. Accessed July 2026. https://techcrunch.com/2025/09/03/firstclub-bucks-indias-speed-obsession-quickly-triples-valuation-to-120m-with-premium-approach/ — Confirms $23M Series A co-led by returning investors Accel and RTP Global at $120M post-money, with Blume Founders Fund, 2am VC, Paramark Ventures, and Aditya Birla Ventures participating.
...
[^140]: Tracxn, "Perplexity - 2026 Funding Rounds & List of Investors," accessed July 27, 2026. https://tracxn.com/d/companies/perplexity/__V2BE-5ihMWJ1hNb2_u1W7Gry25JzPFCBg-iNWi94XI8/funding-and-investors — Third-party funding database confirms the May 14, 2025 $500M Accel-led round is Perplexity's **Series E**, not Series D. The Series D was the December 18, 2024 $500M @ $9B round led by SoftBank + Nvidia + IVP. Fact-spec sweep 2026-07-27 corrected the round type per this authoritative round sequencing; cross-referenced with YourStory ("SoftBank-backed Perplexity bags $500M funding at $9B valuation," December 2024. https://yourstory.com/2024/12/softbank-backed-perplexity-bags-funding-valuation) and PYMNTS coverage of the December 2024 Series D closing.

[^fixxly1]: Indian Startup News, "Fixxly raises $5.5 million to build AI-powered building materials delivery platform," July 29, 2026. Accessed August 2026. https://indianstartupnews.com/funding/fixxly-raises-55-million-to-build-ai-powered-building-materials-delivery-platform-12207918 — Primary trade press announcement confirming $5.5M seed led by Accel with Fireside Ventures and Lightspeed India Partners participating. Bengaluru-based; founded 2026 by Shezan Bhojani (previously DesignCafe) and Sachith Varma; commercial launch planned September 1, 2026.

[^fixxly2]: YourStory, "Building materials quick commerce startup Fixxly raises $5.5M in seed round," July 29, 2026. Accessed August 2026. https://yourstory.com/2026/07/building-materials-quick-commerce-startup-fixxly-seed-round — Independent Indian startup trade press confirmation of the $5.5M Accel-led seed round with Fireside Ventures and Lightspeed India participating.

[^fixxly3]: SiliconIndia, "Fixxly Raises $5.5 Million Seed Funding to Scale Building Materials," July 2026. Accessed August 2026. https://www.siliconindia.com/startup/startup-funding/fixxly-raises-55-million-seed-funding-to-scale-building-materials-nwid-55127.html — Third independent trade press confirmation of the round.

[^apna1]: Entrackr, "Apna Mart raises Rs 120 Cr in Series C round led by Accel, Fundamentum," July 30, 2026. Accessed August 2026. https://entrackr.com/news/apna-mart-raises-rs-120-cr-in-series-c-round-led-by-accel-fundamentum-12211453 — Primary trade press confirming Rs 120 crore (~$12.7M) Series C co-led by Accel India and Fundamentum (each ₹55 Cr) with Peak XV Partners participating (₹10 Cr); post-money valuation ~₹1,470 crore (nearly double the previous ₹738 crore). Operating revenue grew 2.5x to ₹500 crore in FY26.

[^apna2]: Indian Retailer, "Apna Mart Bags Rs 120 Cr to Expand Grocery and FMCG Business Across India," July 30, 2026. Accessed August 2026. https://www.indianretailer.com/news/funding-alert-apna-mart-bags-rs-120-cr-expand-grocery-and-fmcg-business-across-india — Independent retail-sector trade press confirmation of the ₹120 Cr Series C, co-led by Accel and Fundamentum, with Peak XV Partners participating. Gurugram-based franchise-led omnichannel quick commerce operator focused on Tier II/III cities.

[^sapiom1]: Sapiom, "Sapiom Raises $35M Series A to Power the Next Trillion AI Agents" (company Series A announcement), August 5, 2026. Accessed September 2026. https://www.sapiom.ai/blog/series-a — Primary company source. Confirms Accel as a participating investor in the $35M Series A led by Dragonfly, alongside Gradient, Coinbase Ventures, Operator Collective, Formus Capital, VanEck Ventures, Okta Ventures, Menlo Ventures, Anthropic, and Array Ventures. Also references the prior $15.75M Accel-led seed (Feb 6, 2026). Total funding to date: $50M. Founder & CEO Ilan Zerbib quoted: "Every team is being forced to recreate the same infrastructure before its agents can perform real work. Sapiom exists to remove those barriers."
...
[^ema1]: Marina Temkin, "Ema raises $77M as AI starts eating into enterprise software and services," TechCrunch, September 23, 2026. Accessed September 23, 2026. https://techcrunch.com/2026/09/23/ema-raises-77m-as-ai-starts-eating-into-enterprise-software-and-services/ — Contemporaneous tier-1 tech press confirming Ema's $77M Series B led by Bengaluru-based Creaegis with Accel, Section 32, and Prosus all increasing their stakes; valuation more than quadrupled from the 2024 round; $140M total raised; ~200 employees across Mountain View, Bengaluru, London, and Vancouver; verbatim quotes from CEO Surojit Chatterjee.
[^ema2]: Ema company website, accessed September 23, 2026. https://www.ema.ai/ — Primary company source confirming HQ at 321 Castro St, Mountain View, CA; EmaFusion product combining 100+ AI models, 250+ integrations, 1,000+ actions; customers including NTT DATA and AMS.
[^ema3]: Ema LinkedIn Series B announcement, accessed September 23, 2026. https://www.linkedin.com/company/ema-unlimited/ — Primary company LinkedIn post confirming $77M Series B, Creaegis lead, S32 (Section 32) and Prosus participation with increased stakes; $140M total raised; 4x+ valuation increase from 2024; 50x revenue growth over two years; bookings exceeding $150M; NDR around 180%.

[^cambaero1]: Axios, "Anti-drone defense startup raises $300 million," August 10, 2026. Accessed September 24, 2026. https://www.axios.com/2026/08/10/anti-drone-defense-cambridge-aerospace — Contemporaneous tier-1 press confirming Cambridge Aerospace's $300M Series C on 2026-08-10 at a $3.4B valuation, led by DFJ Growth with Lux Capital, Accel, Lakestar, Never Lift, Ora Global, and Elad Gil participating. Cambridge Aerospace focuses on low-cost interceptors for drones, cruise missiles, and ballistic threats plus associated radar systems.
[^cambaero2]: sUAS News, "Cambridge Aerospace Announces $300M Series C Raise," August 10, 2026. Accessed September 24, 2026 (verified via WebFetch 2026-09-24). https://www.suasnews.com/2026/08/cambridge-aerospace-announces-300m-series-c-raise/ — Primary counter-UAS trade press confirmation. Names DFJ Growth as lead with "Lux, Accel, Lakestar, Never Lift, Ora Global, and Elad Gil & Co" as supporting investors; $3.4B valuation; follows April 2026 $200M Series B at $1.3B; product lineup includes Skyhammer and forthcoming Starhammer (2027).
[^cambaero3]: Business Weekly, "Cambridge Aerospace hits $3.4 billion valuation with $300m Series C led by DFJ Growth," August 2026. Accessed August 30, 2026. https://www.businessweekly.co.uk/posts/cambridge-aerospace-hits-34-billion-valuation-with-300m-series-c-led-by-dfj-growth — Third independent regional trade press confirmation of the $300M Series C at $3.4B valuation, DFJ Growth-led with Accel among participants. UK-based operator across UK, Germany, Poland, Norway, Ukraine, and Australia; MIT professor Steven Barrett co-founder.