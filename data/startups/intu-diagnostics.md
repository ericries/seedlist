...
founded: 2023
founders:
- name: Dr. Skaiste Arbaciauskaite
  role: Co-Founder
- name: Dr. Dirk Kuhlmeier
  role: Co-Founder
last_researched: 2026-06-28
location: Leipzig, Germany
name: Intu Diagnostics
sector:
- healthcare
- diagnostics
- medtech
- molecular-diagnostics
slug: intu-diagnostics
stage_latest: Bridge
status: published
status_company: active
total_raised: €3M+
type: startup
website: https://www.intudiagnostics.com
---

## About

Intu Diagnostics is a Leipzig-based diagnostics spin-off from the Fraunhofer Society, building a decentralised molecular diagnostics platform designed to make high-quality infectious disease testing accessible beyond centralised laboratory environments [^1][^2]. The company's all-in-one cartridge detects pathogenic genetic material using PCR-equivalent methodology without requiring laboratory equipment, power sources, or specialised training — users collect a sample, place it in the cartridge, and check for a colour change within 30 minutes [^1]. The platform's first application is cervical cancer screening via HPV detection, with planned expansion to respiratory viruses, sexually transmitted infections, malaria, and tuberculosis [^1].
