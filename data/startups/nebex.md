...
slug: nebex
type: startup
website: "https://nebex.com"
location: "New York, New York"
founded: 2025
status_company: active
sector: [fintech, space-tech, marketplace, defense, infrastructure]
stage_latest: "Seed"
total_raised: "$30M"
firms:
  - slug: gv
...
Nebex is a New York-based market infrastructure platform for the global space economy, founded in late 2025 by Tejpaul Bhatia (former CEO of Axiom Space) and Anand Subramanian [^1][^2]. The platform operates as an exchange layer that connects space companies directly to sovereign buyers and the capital that moves deals, aiming to make money move through the space industry the way it moves through every other market on Earth [^1][^2]. Nebex says it will use the seed capital to build out its electronic transaction framework, establish compliance guardrails for cross-border defense and aerospace tech trade, and scale its engineering workforce [^1]. The company also announced a banking relationship with J.P. Morgan [^1].
...
|------|-------|--------|------|--------------|
| 2026-06-29 | Seed | $30M | GV | Eniac Ventures, 2048 Ventures, Better Tomorrow Ventures, Oceans Ventures, AIN Ventures, Also Capital, Anagram, Armory Square Ventures, Multiball Capital, Trajectory Capital, VSC Ventures [^1][^2][^3] |
