...
Corgi is a San Francisco-based AI-native, full-stack insurance carrier built for startups, founded in 2024 by Nico Laqua (CEO) and Emily Yuan (COO) [^1]. The company was part of Y Combinator's Spring 2024 batch [^2]. Corgi offers business insurance products including directors and officers liability, errors and omissions, cyber, commercial general liability, hired and non-owned auto, fiduciary liability, and AI liability coverage [^1]. Corgi received full regulatory approval to operate as an insurance carrier in July 2025, and reported annual recurring revenue surpassing $40M by January 2026 [^1]. Notable customers include Deel and Artisan [^2].
...
> "True innovation in insurance requires actuarial science, AI-driven systems, and fundamental policy rethinking."
> — Kanyi Maqubela, Managing Partner, Kindred Ventures [^1]

## What Founders Say

> "Startups move fast, and so should their insurance. Founders shouldn't have to choose between speed, coverage quality and price."
> — Nico Laqua, CEO and Co-Founder, Corgi [^1]

> "Insurance is one of the largest industries in the world, but it's still built on infrastructure from centuries ago. We started with property management and are expanding into trucking insurance, payroll, and small business."
> — Emily Yuan, COO and Co-Founder, Corgi [^3]
...
> — Nico Laqua, CEO and Co-Founder, Corgi [^3]

## Sources

[^1]: PR Newswire, "Corgi Insurance Raises $108 Million, Receives Regulatory Approval to Launch the First Full-Stack Insurance Carrier for Startups," January 9, 2026, accessed April 2026. https://www.prnewswire.com/news-releases/corgi-insurance-raises-108-million-receives-regulatory-approval-to-launch-the-first-full-stack-insurance-carrier-for-startups-302657727.html
