...
Slash is a San Francisco-based AI-native business banking platform that combines FDIC-insured business checking, corporate cards with uncapped cash-back, expense management, treasury, global payments, invoicing, working capital, and stablecoin support into a single platform [^1]. Founded in 2021 by Victor Cardenas (CEO) and Kevin Bai (CTO) — both 19 years old at the time — the company serves more than 5,000 businesses across affiliate marketing, e-commerce, healthcare, and other industries [^1][^2]. Slash reached $250 million in annualized revenue in 2025 and processes more than $30 billion in annualized payment volume [^1]. The company achieved unicorn status with its Series C round at a $1.4 billion valuation [^1].

## Funding History

| Date | Round | Amount | Lead | Co-investors |
|------|-------|--------|------|--------------|
| 2026-04-16 | Series C | $100M | Ribbit Capital | Khosla Ventures, Goodwater Capital, NEA, Y Combinator [^1][^2] |
