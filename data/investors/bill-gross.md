...
A review of the full Idealab company list reveals the following approximate distribution:

- **Internet/Consumer Internet**: ~40 companies (~27%) — including GoTo/Overture, CitySearch, NetZero, eToys, Shopping.com, Answers.com, Internet Brands, CarsDirect, Eve.com, Ice.com, Tickets.com, MyLife, etc.
- **Clean Energy/Cleantech**: ~20 companies (~13%) — including Heliogen, Energy Vault, CarbonCapture, eSolar, Energy Innovations, Energy Cache, Cool Energy, Edisun Microgrids, RayTracker, Thermata, Xosphere, etc.
- **Software/Enterprise**: ~20 companies (~13%) — including X1 Discovery, Lumin, Papaya Payments, Mighty Text, Sellbrite, Perfect Market, etc.
- **Robotics/Hardware**: ~10 companies (~7%) — including Evolution Robotics, Elementary Robotics, Aptera Motors, Desktop Factory, New Matter, etc.
- **Advertising/Marketing Tech**: ~10 companies (~7%) — including Commission Junction, UberMedia, Kinetic Social, Zowdow, etc.
- **Education**: ~8 companies (~5%) — including codeSpark, Sally Ride Science, Learning.net, TopTutors.com, etc.
- **Fintech/Blockchain**: ~8 companies (~5%) — including Coinbase, Gem, ChangeTip, Newbury Payments, etc.
- **Other (telecom, social, gaming, health, etc.)**: ~34 companies (~23%)

*Note: Companies are counted once in their primary category. With 150+ companies across 28 years, many categories overlap. The internet/consumer web dominance reflects Idealab's founding during the dot-com era; clean energy has become the dominant focus since ~2008.*
...
Overwhelmingly Pasadena, California. Idealab's offices are at 130 W. Union Street, Pasadena, and most Idealab companies are incubated on-site or in the greater Los Angeles area [^1][^2].
...
While Gross is often described as an "angel investor," his primary mode of operation is as a company builder/incubator, not a traditional check-writing angel. He rarely invests in companies he did not help conceive. His stated thesis emphasizes timing above all else, but his actual track record shows a pattern of being early — sometimes too early — on technology trends (desktop 3D printing with Desktop Factory, electric vehicles with Aptera, early social networks). His recent pivot to clean energy and climate tech represents a significant shift from the internet-dominated first half of Idealab's history that is consistent with his stated focus on "big, broken" problems.

## Portfolio

### Notable Idealab Companies (Founded/Incubated)
...
[^1]: Caltech Board of Trustees, "Mr. William T. Gross (BS '81)," accessed March 2026. https://board.caltech.edu/board-members/mr-william-t-gross-bs-81

[^2]: Idealab, "Bill Gross," management bio page, accessed March 2026. https://www.idealab.com/bio/management/bill_gross.php
