...
social:
  twitter: "@getpeid"
  linkedin: "linkedin.com/in/carlpei"
status: published
...
**Sample size warning:** Only 5 angel investments are independently verified across public databases [^6][^7]. Percentages would be misleading at this scale, so the analysis below is qualitative.
...
- **Consumer-facing software and creator economy** — Stacked (creator platform, exited) [^6], Steep (productivity/consumer software, 2022) [^6], and Dance (e-bike subscription, 2023) [^6][^9] sit in adjacent consumer-experience categories.
- **India D2C / commerce** — Dukaan (e-commerce enabler for SMB merchants in India, 2021) [^6][^10] is the only verified India bet but is consistent with his repeated public framing of India as a priority market [^5].
