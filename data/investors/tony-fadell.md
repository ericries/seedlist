...
Fadell describes Future Shape / Build Collective as "mentors with money" [^7][^8]. The firm invests exclusively in its own capital with no outside LPs, allowing for fast decision-making and long time horizons [^8].

Fadell has stated that Future Shape "only invest[s] in things that will help the planet, help society or help health" [^9]. He organizes his investment focus around four macro trends: the electrification of everything, the digital connection of everything, the rise of biomanufacturing, and the eradication of waste [^7][^10].
...
- **Climate tech as a throughline.** Fadell's climate focus goes beyond a stated thesis — it is the dominant thread across the portfolio. Battery technology (Advano), digital motors (Turntide), solid-state cooling (Phononic), carbon accounting (Sweep), textile waste reduction (Smartex), 3D-printed recycled materials (Aectual), and alternative proteins (Impossible Foods) all address greenhouse gas reduction or waste elimination.

- **Active mentorship model, not passive capital.** Multiple sources confirm Fadell provides deep operational involvement. Smartex founder Gilberto Loureiro described talking to Fadell "almost every day" [^13]. Fadell designed Ledger Stax as an advisor before joining the board [^4]. He joined the Simbe Robotics board alongside the Series A [^6]. This is consistent with the "mentors with money" positioning.

- **Wide stage range.** Verified investments span from seed (Nothing $7M seed, 2020; mmhmm $4.5M seed, 2020) through Series A ($18.5M Advano, 2020; $24.7M Smartex, 2022; $50M Quibim, 2025) and Series B ($73M Sweep, 2022; Nothing $70M Series B, 2022; Hodinkee Series B, 2020). The $250K-$25M check size range is unusually wide, suggesting Fadell sizes investments based on conviction rather than a fixed allocation model.

- **Co-investor patterns.** Lightspeed Venture Partners co-led with Build Collective in Smartex [^14]. Other recurring co-investors across the portfolio include DCVC (Remedy Robotics, Smartex), Thiel Capital (Advano), and Y Combinator (Advano). The portfolio shows a preference for co-investing with deep tech and climate-focused funds.

- **Notable gap: pure SaaS and consumer internet.** Despite the wide check size range, the portfolio contains almost no pure SaaS or consumer internet companies. Edda (PE software) and CashShield (fraud detection) are the closest, and both have specific domain expertise components. This is consistent with his stated avoidance of "digital bits" investments.

## Portfolio

| Company | Year | Stage | Sector | Source |
|---------|------|-------|--------|--------|
| Advano | 2020 | Series A | Battery / energy storage | [^15] |
| Aectual | ~2019 | Growth | 3D printing / sustainability | [^16] |
| Aryballe | ~2020 | — | Digital olfaction / sensors | [^8][^17] |
| CashShield | ~2017 | — | Fraud detection / fintech | [^3] |
~unknown| Diamond Foundry | — | — | Synthetic diamonds / materials | [^8] |
| Edda | 2022 | Seed | PE/VC management software | [^18] |
| Hodinkee | 2020 | Series B | Watch media / e-commerce | [^19] |
~unknown| Impossible Foods | — | — | Alternative protein / food tech | [^7][^8] |
| Ledger | ~2021 | — | Crypto hardware wallet | [^4] |
~unknown| Menlo Micro | — | — | Microelectronic switches / semiconductors | [^10] |
...
~unknown| Turntide | — | — | Digital motors / energy efficiency | [^10] |
...
- **Former SVP, Apple iPod Division** (2001-2008) — reported to Steve Jobs; oversaw iPod and iPhone hardware teams [^1][^2]
...
- **Co-investor relationship: DCVC** — co-invested in Remedy Robotics, Smartex [^14][^22]

## Sources

[^1]: Tony Fadell, Wikipedia, accessed March 2026. https://en.wikipedia.org/wiki/Tony_Fadell

[^2]: Build Collective, "Meet Tony," accessed March 2026. https://www.buildc.com/meet-tony

[^3]: TechCrunch, "Tony Fadell's newest product? An investing and advisory firm called Future Shape," October 18, 2017. https://techcrunch.com/2017/10/18/tony-fadells-newest-product-an-investing-and-advisory-firm-called-future-shape/

[^4]: BusinessWire, "Tony Fadell, Inventor Of The iPod And Ledger Stax, Joins Ledger's Board of Directors," November 21, 2024. https://www.businesswire.com/news/home/20241121101993/en/Tony-Fadell-Inventor-Of-The-iPod-And-Ledger-Stax-Joins-Ledgers-Board-of-Directors

[^5]: Orionis Biosciences, "About Us," accessed March 2026. https://orionisbio.com/about-us/

[^6]: Talent4Boards, "Simbe Robotics adds Tony Fadel, David Pakman and Ryan Gembala to Board along with raising $26m Series A financing led by Venrock," accessed March 2026. https://talent4boards.com/simbe-robotics-adds-tony-fadel-david-pakman-and-ryan-gembala-to-board-along-with-raising-26m-series-a-financing-led-by-venrock/

[^7]: Sifted, "Tony Fadell is scouting deeptech startups and has tips for founders," accessed March 2026. https://sifted.eu/articles/scouting-deeptech-startups-with-ipod-inventor-tony-fadell

[^8]: Sifted, "Why the inventor of the iPhone will not be investing in the metaverse," 2022. https://sifted.eu/articles/tony-fadell-iphone-inventor-metaverse

[^9]: MCJ Podcast, "Episode 210: Tony Fadell, Future Shape," 2022. https://mcj.vc/inevitable-podcast/tony-fadell

[^10]: TechCrunch, "4 future trends iPod inventor Tony Fadell sees for startups," December 30, 2020. https://techcrunch.com/2020/12/30/for-tony-fadell-the-future-of-startups-is-connected-and-sustainable/

[^11]: Signal by NFX, "Tony Fadell's Investing Profile — Future Shape Principal," accessed March 2026. https://signal.nfx.com/investors/tony-fadell

[^12]: 20VC Podcast, "Tony Fadell 'The Father of The iPod' on Mentors, Self-Doubt, Vulnerability, His Relationship To Money, Why Entrepreneurs Need to Be Coachable, Why VCs Need To Be More Direct & Why The First Trillionaire Will Innovate Around Climate Change," accessed March 2026. https://www.thetwentyminutevc.com/tony-fadell

[^13]: Sifted, "Portuguese Smartex raises $24.7m Series A to modernise clothes factories," 2022 (via search results referencing Loureiro quotes). https://sifted.eu/articles/smartex-series-a-clothes-fashion-news

[^14]: TechCrunch, "Smartex sews up $24.7M to put smarter eyes on textile manufacturing," November 3, 2022. https://techcrunch.com/2022/11/03/smartex-funding/

