...
Gil Ben-Artzy is a Founding Partner of UpWest, a Silicon Valley-based seed fund focused on Israeli founders entering the U.S. market [^1][^2]. He co-founded UpWest in 2012 with Shuly Galili [^3][^4].

Ben-Artzy was born and raised in Kfar Saba, Israel [^5]. He earned a BA in Economics and Business Administration from The Hebrew University of Jerusalem, then relocated to the United States in 2000 to pursue an MBA from The Wharton School at the University of Pennsylvania, graduating with honors [^6][^7].

After Wharton, Ben-Artzy joined The Boston Consulting Group in New York, where he advised Fortune 500 companies [^6][^7]. In 2005, he moved to Silicon Valley to join Yahoo!'s Corporate Development group, where he worked on strategy and acquisitions and managed relationships with the Israeli tech ecosystem [^6][^7]. During his time at Yahoo!, he led the acquisition of FoxyTunes, Yahoo!'s first Israel-based startup acquisition, and helped establish the company's first R&D center in Haifa [^6][^7]. He later served as VP of Operations Management at Yahoo! for two years, driving business for the tech infrastructure organization [^7]. He left Yahoo! in the summer of 2011 to launch UpWest Labs [^6][^8].

UpWest began in 2012 as an accelerator program — the only one in the U.S. specifically serving Israeli startups — offering a four-month intensive in Palo Alto with seed investments of $25,000 to $300,000, mentorship from executives at companies like PayPal, Facebook, and Dropbox, and group housing in Palo Alto [^9][^10]. The firm has since evolved into a dedicated pre-seed and seed-stage venture fund.

UpWest has raised four funds: Fund I (~$2M, bootstrapped from friends and colleagues), Fund II, Fund III ($18.5M, closed 2018), and Fund IV ($70M, closed 2021) [^3][^4][^11][^12]. As of 2026, the firm has invested in 100+ Israeli startups, with a collective portfolio market cap exceeding $20 billion and over $3 billion in follow-on funding raised by portfolio companies [^1][^13][^14]. In January 2026, Ben-Artzy stated: "This is the most active investment period we've had in recent years" [^14].
...
On what Israeli startups need to succeed in the U.S., Ben-Artzy has stated: "You need to be doing something that has a chance of being HUGE. VC economics mandate that any startup investment must have the potential to return the fund" [^15]. He has also emphasized that "Being in market increases your likelihood to build amazing businesses, amazing companies" [^5].
...
|---------|------|-------|--------|--------|
| HoneyBook | 2012 | Pre-seed | Business Management | [^1][^17] |
| SentinelOne | 2013 | Pre-seed | Cybersecurity | [^1][^5] |
...
*Note: Exit-year estimates for early companies use the best available data. UpWest has invested in 100+ companies; this table represents approximately 61 verified investments (~61% of the total). Of 85 investments tracked as of 2021, UpWest reported 25 exits and 22 company closures [^11].*
...
**On what Israeli startups need to raise in the U.S.:**
> "You need to be doing something that has a chance of being HUGE. VC economics mandate that any startup investment must have the potential to return the fund — and fund sizes are typically quite large in the US." [^15]
...
**On adding value from day one:**
> "Small company or large, thousands of users or zero, the point is to give value from day one." [^15]
...
> "The first guy that gave us the $25,000 was Gil Ben Artzi." Alon described how this initial investment from Ben-Artzy convinced the HoneyBook co-founders to relocate from Israel to Palo Alto, with Ben-Artzy offering: "I'm going to seed you. Once you start the company, I'm going to seed it." [^17]

**Oz Alon, Co-Founder and CEO of HoneyBook (via UpWest website):**
> "The UpWest team excels at helping founders immerse in the US market to meet real customers and establish footing." [^1]

**Tomer Weingarten, Co-Founder and CEO of SentinelOne (via UpWest website):**
> "UpWest helped create momentum... the community functions like family, becoming part of company culture." [^1]

**Unnamed founder (via UpWest website):**
> Operating early in Silicon Valley alongside the UpWest team "opened a whole new world of possibilities" and founders successfully "onboarded new customers that supercharged their entire business." [^1]

**Unnamed former accelerator participant (via search results):**
> "Gil is a machine. The amount of work he does and his dedication are just incredible. During the UpWest Labs program he spent more time at the office than anyone else." [^19]

**Unnamed former accelerator participant (via search results):**
> "Gil knows everything and everybody. He was an absolute pleasure to work with, and his knowledge of Israel's tech industry and the Silicon Valley tech scene is unparalleled." [^19]

*Note: The Tomer Weingarten and Oz Alon quotes sourced from the UpWest website are firm-curated testimonials. The Oz Alon quote from the Alejandro Cremades interview is independently sourced. The unnamed participant quotes appeared in search results referencing UpWest-related content.*
...
[^5]: "'I get great joy from working with various domains and various founders, and being there for them,'" Calcalist (CTech), accessed March 2026. https://www.calcalistech.com/ctech/articles/0,7340,L-3917539,00.html

[^6]: "About," Gil Ben-Artzy personal website, accessed March 2026. https://gilbenartzy.com/about/

[^7]: Gil Ben-Artzy, Silicon Valley Open Doors (SVOD) speaker profile, accessed March 2026. https://www.svod.org/gil-ben-artzy/

[^8]: "Find & Replace: Traction -> Momentum," Gil Ben-Artzy personal blog, November 7, 2011. https://gilbenartzy.com/

[^9]: "UpWest Labs Nurtures Promising Israeli Startups In Silicon Valley," TechCrunch, November 10, 2014. https://techcrunch.com/2014/11/10/upwest-labs-nurtures-promising-israeli-startups-in-silicon-valley/

[^10]: "With $3M invested in its graduates, UpWest Labs unveils six new startups," PR Newswire, accessed March 2026. https://www.prnewswire.com/news-releases/with-3m-invested-in-its-graduates-upwest-labs-unveils-six-new-startups-176594421.html

[^11]: "Early stage VC UpWest raises $70m fourth fund," Globes, November 2021. https://en.globes.co.il/en/article-early-stage-vc-upwest-raises-70m-fourth-fund-1001389938

[^12]: "UpWest announces new $70 million seed fund," Calcalist (CTech), November 2021. https://www.calcalistech.com/ctech/articles/0,7340,L-3921723,00.html

[^13]: "Shuly Galili of UpWest on building lasting partnerships," Venture Unlocked (Substack), accessed March 2026. https://ventureunlocked.substack.com/p/shuly-galili-of-upwest-on-building

[^14]: "UpWest promotes Aya Neeman to Principal," Calcalist (CTech), January 2026. https://www.calcalistech.com/ctechnews/article/bkznm7ibzx

[^15]: "Ask Me Anything: Gil Ben-Artzy," UpWest Medium blog, accessed March 2026. https://medium.com/upwest-labs/ask-me-anything-gil-ben-artzy-7d8267d6b021

[^16]: "From Our First Check to IPO — SentinelOne is Now Public on the NYSE," UpWest Medium blog, accessed March 2026. https://medium.com/upwest-labs/from-our-first-check-to-ipo-sentinelone-is-now-public-on-the-nyse-e8c0b2143b59

[^17]: "Oz Alon On Building A $1 Billion Company By Reinventing Business Management For SMBs," Alejandro Cremades, accessed March 2026. https://alejandrocremades.com/oz-alon/

[^18]: Gil Ben-Artzy's Investing Profile, Signal by NFX, accessed March 2026. https://signal.nfx.com/investors/gil-ben-artzy

[^19]: UpWest founder/participant testimonials, referenced in web search results, accessed March 2026. https://upwest.vc/
