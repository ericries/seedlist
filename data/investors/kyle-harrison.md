...
At Index Ventures, Harrison served as a Principal and was an investor and board member at companies including Coalition, Persona, Anrok, Cocoon, Shopmonkey, ServiceTitan, Tekion, and Gong [^3][^4]. At Coatue, he worked as a Growth Investor contributing to investment strategies across global markets [^3]. Across these prior firms, he led or participated in investments in Ramp, Pave, Anduril, GitLab, Databricks, and Snowflake [^1][^2].
...
Harrison is also known as a prolific writer. He publishes a weekly newsletter called "Investing 101" on Substack, which has amassed over 25,000 subscribers across 208+ posts and more than 500,000 words over five years without missing a single week [^2][^7].
...
|---------|-------|------|--------|
| Ramp | Series B+ | 2021 | [^11][^12] |
~unknown| Anduril | Growth | -- | [^1][^7] |
~unknown| Pave | -- | -- | [^1][^2] |
~unknown| Replit | -- | -- | [^7] |
~unknown| OneSchema | -- | -- | [^7] |
~unknown| Moment | -- | -- | [^7] |
~unknown| Nomic | -- | -- | [^7] |
~unknown| Teamshares | -- | -- | [^7] |
~unknown| Synthesis | -- | -- | [^1][^7] |
~unknown| Armada | -- | -- | [^7] |
~unknown| Power | -- | -- | [^7] |
~unknown| Modern Intelligence | -- | -- | [^7] |
~unknown| Patch | -- | -- | [^7][^13] |
~unknown| Hallow | -- | -- | [^1][^13] |
~unknown| Leland | -- | -- | [^1] |
~unknown| Secureframe | -- | -- | [^13] |
~unknown| Sora Schools | -- | -- | [^13] |
...
|---------|-------|------|--------|
~unknown| Coalition | Growth | Index Ventures | [^3][^4] |
~unknown| Persona | Growth | Index Ventures | [^3][^4] |
~unknown| Anrok | Growth | Index Ventures | [^3][^4] |
~unknown| Cocoon | Growth | Index Ventures | [^3][^4] |
~unknown| Shopmonkey | Growth | Index Ventures | [^3][^4] |
~unknown| ServiceTitan | Growth | Index Ventures | [^3][^4] |
~unknown| Tekion | Growth | Index Ventures | [^3][^4] |
~unknown| Gong | Growth | Index Ventures | [^3][^4] |
~unknown| GitLab | Growth | Prior firm | [^1][^2] |
~unknown| Databricks | Growth | Prior firm | [^1][^2] |
~unknown| Snowflake | Growth | Prior firm | [^1][^2] |
...
- **Former Principal, Index Ventures** — board member alongside Index partners at Coalition, Persona, Anrok, Cocoon, Shopmonkey, ServiceTitan, Tekion, and Gong [^3][^4]
- **Former Growth Investor, Coatue Management** [^3]
- **Former investor, Technology Crossover Ventures (TCV)** [^1][^2]
