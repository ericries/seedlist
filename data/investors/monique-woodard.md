...
Monique Woodard is the Founding Partner and Managing Director of Cake Ventures, a pre-seed and seed-stage venture capital firm she founded in 2021 [^1][^2]. The firm focuses on investing in technology companies whose growth is accelerated by major demographic changes [^1].

Before launching Cake Ventures, Woodard served as a Venture Partner at 500 Startups (now 500 Global) from 2016 to 2018, where she invested in early-stage companies across the United States and Africa [^3][^4]. At 500 Startups, she led a $25 million microfund focused on early-stage investments in businesses owned by Black and Latino founders [^5]. She also led 500's investing and deal flow pipeline in sub-Saharan Africa and led Geeks on a Plane, a tour of Africa's startup ecosystems [^5]. She was the first African-American venture partner at 500 Startups [^6].

After 500 Startups, Woodard served as a Venture Scout at Lightspeed Venture Partners, building deal-sourcing and evaluation skills [^3][^7]. She has also served as an advisor to SoftBank on their Emerge program, an early-stage pipeline program focused on companies led by underrepresented entrepreneurs [^3].

Prior to moving to the investor side, Woodard spent over 15 years in the tech industry as an entrepreneur and operator [^1]. She co-founded Black Founders in 2011, an organization dedicated to increasing the number of successful Black entrepreneurs in technology [^3][^8]. She also created Speak Chic, a mobile app that teaches users how to pronounce fashion brand names, which was featured in Harper's Bazaar, Cosmopolitan, and InStyle [^3].
...
Woodard structures her thesis around what she calls "the three layers of cake" — three demographic megatrends she believes will create trillions of dollars in investment opportunity [^10][^11]:

1. **Aging and longevity**: With 10,000 people turning 65 every day in the United States, Woodard sees growing demand for solutions in care, aging in place, preventative health, and late-life financial services [^2][^10].
2. **The female economy**: A $30 trillion wealth transfer to women over the next decade, driving opportunities in women's health, direct-to-consumer brands, and financial empowerment [^2][^10].
3. **The shift to majority-minority**: As people of color become the majority in the United States — with Gen Alpha already leading that demographic shift — Woodard sees emerging opportunities in serving diverse consumer markets [^2][^10].
...
The analysis below is based on 20 verified investments from Cake Ventures' portfolio page, press coverage, and aggregator data [^1][^13][^14][^15].

**Sector concentration (based on 20 verified investments):**
- Digital health / women's health / aging: 8 of 20 (40%) — Guaranteed, Frame Fertility, Eli Health, Culina Health, Aster, Sol Health, Death Clock, Tendercare
- Consumer products / e-commerce: 4 of 20 (20%) — Pamper, Shop McMullen, Rares, Snack
- Future of work / workforce: 3 of 20 (15%) — Bright, STAND+, NextWork
- B2B / enterprise / AI: 2 of 20 (10%) — EasyMateAI, Lotus Labs
- Insurtech / fintech: 1 of 20 (5%) — TenYour
- Community / social: 1 of 20 (5%) — Serif
- Benefits / care platform: 1 of 20 (5%) — Joshin
...
- **True pre-seed/seed investor**: Cake Ventures writes first checks of $200K-$750K at the pre-seed and seed stage [^1][^14]. The firm does not lead rounds [^14]. This positions Cake as a smaller, conviction-driven check rather than a round-leading fund.
...
- **Venture Partner, 500 Startups (now 500 Global)** (2016-2018) — first African-American venture partner at the firm [^5][^6]
...
[^1]: Cake Ventures, "Funding The Future — About," accessed March 2026. https://www.cake.vc/about
[^2]: Black Enterprise, "Cake Ventures, Founded by Monique Woodard, Debuts First Fund," January 2023, accessed March 2026. https://www.blackenterprise.com/cake-ventures-founded-by-monique-woodard-debuts-first-fund/
[^3]: monique.vc, "About Monique Woodard," accessed March 2026. https://www.monique.vc/about/
[^4]: Venture Unlocked, "Monique Woodard of Cake Ventures on the 3 layers of the Cake," accessed March 2026. https://ventureunlocked.substack.com/p/moniquewoodard
[^5]: BlackBusiness.com, "This Woman is Investing $25 Million into Black and Latino-Owned Businesses," September 2016, accessed March 2026. https://www.blackbusiness.com/2016/09/monique-woodard-500-startups-investing-25-million-black-latino-owned-businesses.html
[^6]: Moguldom, "Monique Woodard Is Leaving 500 Startups, Destination: Unknown," January 2018, accessed March 2026. https://moguldom.com/143063/monique-woodard-is-leaving-500-startups-destination-unknown-for-now/
[^7]: VC Uncovered, "Monique Woodard — Cake Ventures," accessed March 2026. https://www.vcuncovered.com/p/monique-woodard-cake-ventures
[^8]: Startup Grind Cape Town, "Monique Woodard, Investor, 500 Startups," accessed March 2026. https://www.startupgrind.com/events/details/startup-grind-cape-town-presents-monique-woodard-investor-500-startups/
[^9]: Kauffman Fellows, "Monique Woodard — Directory," accessed March 2026. https://www.kauffmanfellows.org/fellows/monique-woodard
[^10]: Consumer VC Podcast (Spotify), "Monique Woodard (Cake Ventures) — The three layers of cake investment thesis," accessed March 2026. https://open.spotify.com/episode/5oSbShwSoJbLOwXrbycMp0
[^11]: monique.vc, "Placing Big Bets on Demographic Change," April 2025, accessed March 2026. https://www.monique.vc/placing-big-bets-on-demographic-change/
[^12]: AfroTech, "Monique Woodard Takes Her 'Layered' Investment Approach To A New Level With $17M Fund," January 2023, accessed March 2026. https://afrotech.com/cake-ventures-17m-fund
[^13]: Cake Ventures, "News," accessed March 2026. https://www.cake.vc/news
[^14]: VCSheet, "Cake Ventures — VC Fund Breakdown," accessed March 2026. https://www.vcsheet.com/fund/cake-ventures
[^15]: VoxelMatters, "Koobz closes seed round, bringing total funding to $7.2M," accessed March 2026. https://www.voxelmatters.com/koobz-closes-seed-round-bringing-total-funding-to-7-2m/
[^16]: Signal by NFX, "Monique Woodard's Investing Profile," accessed March 2026. https://signal.nfx.com/investors/monique-woodard
